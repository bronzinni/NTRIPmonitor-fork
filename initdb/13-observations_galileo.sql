CREATE TABLE IF NOT EXISTS observations_galileo (
    obs_id BIGSERIAL,
...
SELECT drop_chunks('observations_galileo', older_than => INTERVAL '2 months');
SELECT add_retention_policy('observations_galileo', INTERVAL '2 months');
