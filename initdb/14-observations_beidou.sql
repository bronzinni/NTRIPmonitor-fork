CREATE TABLE IF NOT EXISTS observations_beidou (
    obs_id BIGSERIAL,
...
SELECT drop_chunks('observations_beidou', older_than => INTERVAL '2 months');
SELECT add_retention_policy('observations_beidou', INTERVAL '2 months');
