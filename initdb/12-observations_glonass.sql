CREATE TABLE IF NOT EXISTS observations_glonass (
    obs_id BIGSERIAL,
...
SELECT drop_chunks('observations_glonass', older_than => INTERVAL '2 months');
SELECT add_retention_policy('observations_glonass', INTERVAL '2 months');
